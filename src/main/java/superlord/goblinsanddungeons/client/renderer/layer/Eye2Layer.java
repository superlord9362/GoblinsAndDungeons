...
public class Eye2Layer extends RenderLayer<Beholder, EntityModel<Beholder>> {
	
	public Eye2Layer(RenderLayerParent<Beholder, EntityModel<Beholder>> p_117346_) {
		super(p_117346_);
	}

	private static final RenderType TEXTURE = RenderType.entityCutoutNoCull(new ResourceLocation(GoblinsAndDungeons.MOD_ID, "textures/entities/beholder/eye_2_shut.png"));
