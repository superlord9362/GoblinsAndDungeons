...
public class GoblinSoulBulletEntity extends ThrowableItemProjectile {
	public GoblinSoulBulletEntity(EntityType<? extends GoblinSoulBulletEntity> p_i50159_1_, Level p_i50159_2_) {
		super(p_i50159_1_, p_i50159_2_);
	}

	public GoblinSoulBulletEntity(Level worldIn, LivingEntity throwerIn) {
		super(EntityInit.GOBLIN_SOUL_BULLET.get(), throwerIn, worldIn);
	}

	public GoblinSoulBulletEntity(Level worldIn, double x, double y, double z) {
