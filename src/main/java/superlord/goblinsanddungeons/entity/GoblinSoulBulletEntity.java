...
public class GoblinSoulBulletEntity extends ProjectileEntity {
   ...
   public GoblinSoulBulletEntity(EntityType<? extends GoblinSoulBulletEntity> type, World worldIn) {
		super(type, worldIn);
		this.noClip = true;
	}

   @OnlyIn(Dist.CLIENT)
   public GoblinSoulBulletEntity(World worldIn, double x, double y, double z, double motionXIn, double motionYIn, double motionZIn) {
      this(EntityInit.GOBLIN_SOUL_BULLET.get(), worldIn);
      this.setLocationAndAngles(x, y, z, this.rotationYaw, this.rotationPitch);
      this.setMotion(motionXIn, motionYIn, motionZIn);
   }

   public GoblinSoulBulletEntity(World worldIn, LivingEntity ownerIn, Entity targetIn) {
      this(EntityInit.GOBLIN_SOUL_BULLET.get(), worldIn);
...
public void tick() {
      ...
      if (this.world.isRemote) {
         this.world.addParticle(ParticleTypes.SOUL_FIRE_FLAME, this.getPosX() - vector3d1.x, this.getPosY() - vector3d1.y + 0.15D, this.getPosZ() - vector3d1.z, 0.0D, 0.0D, 0.0D);
