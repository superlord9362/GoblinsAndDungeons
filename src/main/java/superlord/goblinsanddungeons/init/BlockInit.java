...
public class BlockInit {
    ...
    //public static final RegistryObject<Block> ASHED_SOUL_SAND = REGISTER.register("ashed_soul_sand", () -> new SoulSandBlock(Block.Properties.from(Blocks.SOUL_SAND)));
    
    //public static final RegistryObject<Block> SOUL_ASH_CAMPFIRE = REGISTER.register("soul_ash_campfire", () -> new SoulAshCampfireBlock(true, 1, Block.Properties.from(Blocks.CAMPFIRE)));
    //public static final RegistryObject<Block> SOUL_ASH_SOUL_CAMPFIRE = REGISTER.register("soul_ash_soul_campfire", () -> new SoulAshCampfireBlock(false, 2, Block.Properties.from(Blocks.SOUL_CAMPFIRE)));
