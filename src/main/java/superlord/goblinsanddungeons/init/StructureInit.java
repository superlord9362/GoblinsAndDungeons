...
public class StructureInit {
	public static IStructurePieceType SMALL_GOBLIN_CAMP_PIECE_TYPE = null;
	public static IStructurePieceType MEDIUM_GOBLIN_CAMP_PIECE_TYPE = null;
	public static IStructurePieceType LARGE_GOBLIN_CAMP_PIECE_TYPE = null;
	public static IStructurePieceType RUINED_KEEP_PIECE_TYPE = null;
	...
	public static void setupStructures() {
		setupMapSpacingAndLand(SMALL_GOBLIN_CAMP.get(), new StructureSeparationSettings(100, 50, 2734626), true);
		setupMapSpacingAndLand(MEDIUM_GOBLIN_CAMP.get(), new StructureSeparationSettings(100, 50, 25472518), true);
		setupMapSpacingAndLand(LARGE_GOBLIN_CAMP.get(), new StructureSeparationSettings(100, 50, 28163263), true);
		setupMapSpacingAndLand(RUINED_KEEP.get(), new StructureSeparationSettings(100, 50, 173648271), true);
	}
