...
public class SoulBulletItem extends Item {
	...
	public SoulBulletEntity createSoulBullet(Level world, ItemStack stack, LivingEntity shooter) {
		SoulBulletEntity soulBullet = new SoulBulletEntity(world, shooter);
		return soulBullet;
	}
