...
public class BeholderPart extends net.minecraftforge.entity.PartEntity<Beholder> {
   public final Beholder parentMob;
   public final String name;
   private final EntityDimensions size;

   public BeholderPart(Beholder p_31014_, String p_31015_, float p_31016_, float p_31017_) {
      super(p_31014_);
