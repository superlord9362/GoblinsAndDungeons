...
public class WeaknessOrb extends ThrowableItemProjectile {
	public WeaknessOrb(EntityType<? extends WeaknessOrb> p_i50159_1_, Level p_i50159_2_) {
		super(p_i50159_1_, p_i50159_2_);
	}

	public WeaknessOrb(Level worldIn, LivingEntity throwerIn) {
		super(EntityInit.WEAKNESS_ORB.get(), throwerIn, worldIn);
	}

	public WeaknessOrb(Level worldIn, double x, double y, double z) {
		super(EntityInit.WEAKNESS_ORB.get(), x, y, z, worldIn);
	}

	protected Item getDefaultItem() {
		return ItemInit.WEAKNESS_ORB.get();
	}
	...
	protected void onHitEntity(EntityHitResult result) {
		...
		if (hitEntity instanceof LivingEntity) {
			...
			((LivingEntity)hitEntity).addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 150));
		}
