...
public class SoulBullet extends ThrowableItemProjectile {
	public SoulBullet(EntityType<? extends SoulBullet> p_i50159_1_, Level p_i50159_2_) {
		super(p_i50159_1_, p_i50159_2_);
	}

	public SoulBullet(Level worldIn, LivingEntity throwerIn) {
		super(EntityInit.SOUL_BULLET.get(), throwerIn, worldIn);
	}

	public SoulBullet(Level worldIn, double x, double y, double z) {
