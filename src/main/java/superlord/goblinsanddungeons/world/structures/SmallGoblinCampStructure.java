...
public class SmallGoblinCampStructure extends Structure<NoFeatureConfig> {
	...
	public SmallGoblinCampStructure(Codec<NoFeatureConfig> config) {
		super(config);
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation2, List<StructurePiece> pieceList, Random rand) {
			...
			pieceList.add(new Piece(templateManager, new ResourceLocation(GoblinsAndDungeons.MOD_ID, "small_goblin_camp"), blockPos, rotation2));
		}
