...
public class SmallGoblinCampStructure extends Structure<NoFeatureConfig> {

	public SmallGoblinCampStructure(Codec<NoFeatureConfig> p_i51440_1_) {
        super(p_i51440_1_);
    }

    public String getStructureName() {
        return GoblinsAndDungeons.MOD_ID + ":small_goblin_camp";
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return SmallGoblinCampStructure.Start::new;
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
            ...
            pieceList.add(new Piece(templateManager, new ResourceLocation(GoblinsAndDungeons.MOD_ID, "small_goblin_camp"), blockpos, rotation));
        }
