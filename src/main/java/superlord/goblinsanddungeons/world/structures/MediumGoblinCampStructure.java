...
public class MediumGoblinCampStructure extends Structure<NoFeatureConfig> {
	...
	public MediumGoblinCampStructure(Codec<NoFeatureConfig> p_i51440_1_) {
        super(p_i51440_1_);
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
            ...
            pieceList.add(new Piece(templateManager, new ResourceLocation(GoblinsAndDungeons.MOD_ID, "medium_goblin_camp"), blockpos, rotation));
        }
